        ...
        <div className="w-full">
            <div className="bg-white min-h-32 rounded-xl shadow-md my-5">
                ...
                <div className="flex items-center justify-center space-x-2 py-3 mx-4 border-b border-gray-200">
                    ...
                    >
                        {name && user.uid !== uid ? `Viết gì đó cho ${name}` : `${user.displayName?.split(' ').pop()} ơi, bạn đang nghĩ gì thế`} 
                    </button>
                </div>
                    ...
                    <div className="flex flex-col justify-between flex-1 space-y-3">
                        ...
                        <div className="pt-3 flex space-x-5">
                            ...
                            <textarea 
                                ...
                                ref={ postContentRef }
                                placeholder={name ? `Viết gì đó cho ${name}` : `${user.displayName?.split(' ').pop()} ơi, bạn đang nghĩ gì thế ?`}
