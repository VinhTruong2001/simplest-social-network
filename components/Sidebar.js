...
function Sidebar() {
    ...
    return (
        <div className={`bg-[#1d3faa] flex flex-col absolute z-50 lg:sticky top-0 h-screen w-[236px] py-4 transform -translate-x-full ${sidebarStatus && 'translate-x-0'} transition lg:transform-none`}>
            {/* Logo */}
           <div className="border-b border-white flex items-center lg:block">
                <Link href="/">
